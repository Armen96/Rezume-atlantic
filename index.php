        ...
        <div class="pt-wrapper">
            ...
            <div class="subpages">
                ...
                <section class="pt-page pt-page-1" data-id="about_me">
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-6 col-md-6 subpage-block">
                            <div class="general-info">
                                ...
                                <p>
                                    ...
                                    I have been working as a web developer for 3 years.
                        ...
                        <div class="col-sm-6 col-md-6 subpage-block">
                            ...
                            <!--<p>"Great addition to our marketing team and always gave us a solution for any issues that occured."</p>-->
                            <!--</div>-->
                            <!--</div>-->
                            <!--&lt;!&ndash; /Testimonial Content &ndash;&gt;-->
                            ...
                            <!--<img src="images/testimonials/recommended.png" alt="">-->
                            <!--</div>-->
                            <!--&lt;!&ndash; /Picture &ndash;&gt;-->
                            <!--&lt;!&ndash; Testimonial author information &ndash;&gt;-->
                            <!--<div class="testimonial-author-info">-->
                            <!--<p class="testimonial-author">Mark Townsend</p>-->
                            <!--<p class="testimonial-firm">Amazon</p>-->
                            <!--</div>-->
                            <!--</div>-->
                            <!--&lt;!&ndash; /Testimonial author information &ndash;&gt;-->
                            <!--</div>-->
                            ...
                            <!--<div class="testimonial-content">-->
                            <!--<div class="testimonial-text">-->
                            <!--<p>"Could not have pictured a better manager for our marketing team. Has increased our advertising efforts exponentially and brings great charisma to the table every day."</p>-->
                            <!--</div>-->
                            <!--</div>-->
                            <!--&lt;!&ndash; /Testimonial Content &ndash;&gt;-->
                            <!--&lt;!&ndash; Testimonial Author &ndash;&gt;-->
                            ...
                            <!--<p class="testimonial-firm">Facebook</p>-->
                            <!--</div>-->
                            <!--</div>-->
                            <!--&lt;!&ndash; /Testimonial author information &ndash;&gt;-->
                            <!--</div>-->
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-6 col-md-3 subpage-block">
                            <div class="fun-fact-block">
                                ...
                                <h4>Working Hours</h4>
                                <span class="fun-value">4000+</span>
                            </div>
                        </div>
                        ...
                        <div class="col-sm-6 col-md-3 subpage-block">
                            <div class="fun-fact-block">
                                ...
                                <span class="fun-value">1400+</span>
                            </div>
                        </div>
                    </div>
                ...
                <section class="pt-page pt-page-2" data-id="resume">
                        ...
                        <div class="col-sm-6 col-md-4 subpage-block">
                            ...
                            <div class="timeline">
                                <div class="timeline-event te-primary">
                                    ...
                                    <h4 class="event-name">Fizmat School</h4>
                                </div>
                    ...
                    <!--<a class="button" target="_blank" href="index.html#">Download CV</a>-->
                    <!--</div>-->
                    <!--</div>-->
                    <!--</div>-->
                </section>
                ...
                <section class="pt-page pt-page-3" data-id="portfolio">
                    ...
                    <div class="portfolio-content">
                        <div class="portfolio-grid portfolio-masonry masonry-grid-3">
                            ...
                            <div class="item col-lg-4 col-md-6 col-sm-6 xs-12" style="height: 600px">
                                <a href="https://keepical.com/" title="Keepical" class="lightbox mfp-iframe">
                                    <img src="images/keepical475.png" style="height: 300px" alt="">
                                    <div>
                            ...
                            <div class="item col-lg-4 col-md-6 col-sm-6 xs-12" style="height: 600px">
                                <a href="https://www.sharehive.co/" title="Sharehive" class="lightbox mfp-iframe">
                                    <img src="images/sharehive53.jpg" style="height: 300px" alt="">
                                    <div>
                            ...
                            <div class="item col-lg-4 col-md-6 col-sm-6 xs-12" style="height: 600px">
                                <a href="http://global-data.eu/" title="Global data (Netherlands)" class="lightbox mfp-iframe">
                                    <img src="images/globaldata.jpg" style="height: 300px" alt="">
                                    <div>
                            ...
                            <div class="item col-lg-4 col-md-6 col-sm-6 xs-12" style="height: 600px">
                                <a href="https://www.20min.ch/" title="20 Minuten" class="lightbox mfp-iframe">
                                    <img src="images/20min.jpg" style="height: 300px" alt="">
                                    <div>
